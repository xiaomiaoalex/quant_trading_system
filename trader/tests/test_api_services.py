...
class TestStrategyService:
    ...
    def test_get_strategy(self):
        ...
        request = StrategyRegisterRequest(
            strategy_id="strat_001", name="Test", entrypoint="test:Strategy"
        )
    ...
    def test_list_strategies(self):
        ...
        request1 = StrategyRegisterRequest(
            strategy_id="strat_001", name="Test1", entrypoint="test1:Strategy"
        )
        request2 = StrategyRegisterRequest(
            strategy_id="strat_002", name="Test2", entrypoint="test2:Strategy"
        )
    ...
    def test_create_version(self):
        ...
        version_request = StrategyVersionCreateRequest(
            version="1", code_ref="git:abc123", param_schema={"param1": {"type": "number"}}
        )
    ...
    def test_list_versions(self):
        ...
        version_request = StrategyVersionCreateRequest(
            version="1", code_ref="git:v1", param_schema={}
        )
    ...
    def test_create_params(self):
        ...
        params_request = VersionedConfigUpsertRequest(
            scope="strat_001", config={"max_position": 100}, created_by="admin"
        )
...
class TestRiskService:
    ...
    def test_set_limits(self):
        ...
        request = VersionedConfigUpsertRequest(
            scope="GLOBAL", config={"max_daily_loss": 5000}, created_by="admin"
        )
    ...
    def test_get_limits(self):
        ...
        request = VersionedConfigUpsertRequest(
            scope="GLOBAL", config={"max_position": 1000}, created_by="admin"
        )
    ...
    async def test_concurrent_upgrade_idempotency(self):
        ...
        async def try_upgrade_and_set():
            ...
            if is_first:
                await killswitch_service.set_state(
                    KillSwitchSetRequest(scope="TEST", level=2, reason="test", updated_by="test")
                )
    ...
    async def test_duplicate_effect_idempotency(self):
        ...
        is_first_upgrade_dup, is_first_effect_dup = (
            await self.service.try_record_upgrade_with_effect(
                upgrade_key1,
                "TEST",
                5,
    ...
    async def test_step6_failure_pending_effect_recovery(self):
        ...
        ks.set_state(
            KillSwitchSetRequest(scope="TEST", level=2, reason="recovered", updated_by="recovery")
        )
    ...
    async def test_step2_dedup_failure_no_upgrade_recorded(self):
        ...
        event_id1, created1, is_first_upgrade1, is_first_effect1 = (
            await self.service.ingest_event_with_upgrade(event_data, upgrade_key, 2)
        )
        ...
        event_id2, created2, is_first_upgrade2, is_first_effect2 = (
            await self.service.ingest_event_with_upgrade(event_data, upgrade_key, 2)
        )
...
class TestKillSwitchService:
    ...
    def test_set_state(self):
        ...
        request = KillSwitchSetRequest(
            scope="GLOBAL", level=2, reason="Emergency", updated_by="admin"
        )
