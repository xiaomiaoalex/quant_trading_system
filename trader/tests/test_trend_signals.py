...
class TestPriceMomentum:
    ...
    def test_bullish_momentum(self):
        ...
        prices = make_price_samples(
            [90, 92, 94, 96, 98, 100, 102, 104, 106, 108, 110, 112, 114, 115, 118]
        )
    ...
    def test_bearish_momentum(self):
        ...
        prices = make_price_samples(
            [115, 113, 111, 109, 107, 105, 103, 101, 99, 97, 95, 93, 91, 90, 88]
        )
    ...
    def test_strong_momentum(self):
        ...
        prices = make_price_samples(
            [85, 87, 89, 91, 93, 95, 97, 99, 101, 103, 105, 107, 109, 112, 115]
        )
    ...
    def test_weak_momentum(self):
        ...
        prices = make_price_samples(
            [100, 101, 100, 101, 100, 101, 100, 101, 100, 101, 100, 101, 100, 101, 102]
        )
...
class TestTrendSignalDataClassImmutability:
    ...
    def test_ema_result_immutable(self):
        ...
        prices = make_price_samples(
            [100, 102, 105, 107, 110, 115, 120, 125, 130, 135, 140, 145, 150, 155, 160]
        )
...
class TestTrendSignalEdgeCases:
    ...
    def test_zero_prices(self):
        """测试价格序列包含零"""
        prices = make_price_samples(
            [100, 0, 105, 107, 110, 115, 120, 125, 130, 135, 140, 145, 150, 155, 160]
        )
        result = EMACrossover.compute("BTCUSDT", prices, fast_period=5, slow_period=10)
        # 零价格可能导致计算问题，应该优雅处理
    ...
    def test_custom_ts_ms(self):
        ...
        result = EMACrossover.compute(
            "BTCUSDT", prices, fast_period=5, slow_period=10, ts_ms=custom_ts
        )
