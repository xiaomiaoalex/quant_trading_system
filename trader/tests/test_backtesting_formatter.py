...
class TestReportFormatter(unittest.TestCase):
    ...
    def test_calculate_volatility(self):
        ...
        returns = [
            Decimal(str(r)) for r in [0.01, -0.005, 0.015, 0.008, -0.002, 0.012, -0.008, 0.01]
        ]
    ...
    def test_calculate_equity_drawdown(self):
        ...
        equity_curve = [
            ...
            {"timestamp": datetime(2023, 2, 1, tzinfo=timezone.utc), "equity": 110000},
            {
                ...
                "equity": 105000,
            },  # Drawdown from 110000
            {"timestamp": datetime(2023, 4, 1, tzinfo=timezone.utc), "equity": 115000},
        ]

        max_dd, max_dd_pct = self.formatter._calculate_equity_drawdown(
    ...
    def test_format_with_benchmark(self):
        ...
        report = self.formatter.format_with_benchmark(
            report_wrapper, self.config, benchmark, "TestStrategy"
        )
...
class TestReportFormatterEdgeCases(unittest.TestCase):
    ...
    def test_single_point_equity_curve(self):
        ...
        equity_curve = [{"timestamp": datetime(2023, 1, 1, tzinfo=timezone.utc), "equity": 100000}]
...
class TestBacktestVisualizer(unittest.TestCase):
    ...
    def test_visualizer_integration_with_report(self):
        ...
        from trader.services.backtesting.visualizer import _HAS_MATPLOTLIB, BacktestVisualizer
