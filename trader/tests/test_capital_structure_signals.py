...
class TestFundingRateZScore:
    ...
    def test_compute_insufficient_history_returns_none(self):
        ...
        history = [
            FundingRateSample(ts_ms=1000 + i * 8 * 3600000, funding_rate=0.0001) for i in range(5)
        ]
    ...
    def test_compute_zero_std_returns_none(self):
        ...
        # 所有历史值相同，标准差为0
        history = [
            FundingRateSample(ts_ms=1000 + i * 8 * 3600000, funding_rate=0.0001) for i in range(20)
        ]
...
class TestLongShortRatioAnomaly:
    ...
    def test_normal_ratio(self):
        ...
        history = [
            LongShortSample(ts_ms=1000 + i * 8 * 3600000, long_short_ratio=1.0) for i in range(20)
        ]
    ...
    def test_zero_mean_ratio(self):
        ...
        # 历史值都很小，接近0
        history = [
            LongShortSample(ts_ms=1000 + i * 8 * 3600000, long_short_ratio=0.01) for i in range(20)
        ]
...
class TestEdgeCases:
    ...
    def test_funding_rate_with_identical_values(self):
        """所有资金费率相同"""
        history = [FundingRateSample(ts_ms=i, funding_rate=0.0001) for i in range(30)]
    ...
    def test_extreme_ratio_identical_history(self):
        """多空比历史全相同"""
        history = [LongShortSample(ts_ms=i, long_short_ratio=1.0) for i in range(30)]
    ...
    def test_large_window_vs_small_history(self):
        ...
        history = [
            FundingRateSample(ts_ms=i, funding_rate=0.0001 + (i % 3) * 0.00002) for i in range(5)
        ]
