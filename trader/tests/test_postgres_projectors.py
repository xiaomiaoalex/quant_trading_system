...
class TestRiskProjectorStateTransitions:
    ...
    def test_risk_check_passed(self):
        ...
        projector = self._create_projector()
        events = [
            self._create_event("RISK_CHECK_PASSED", 0, {"timestamp": "2024-01-01T00:00:00+00:00"})
        ]
...
def test_projector_event_types():
    ...
    position_projector._event_types = {
        et.value for et in EventType if et.name.startswith("POSITION")
    }
